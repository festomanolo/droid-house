...
android {
    namespace = "com.droidhouse.companion"
    compileSdk = 35
    buildToolsVersion = "35.0.0"

    defaultConfig {
        applicationId = "com.droidhouse.companion"
        minSdk = 29
        targetSdk = 35
        versionCode = 2
        versionName = "2.0"
...
dependencies {
    ...
    // Jetpack Compose — spatial companion UI
    ...
    // Ktor — local bridge server on port 8080 (adb forward)
